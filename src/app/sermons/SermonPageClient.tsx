...
const SermonPageClient = () => {
  ...
  return (
    ...
    >
      <PageHero
        eyebrow="Sermons"
        title="Each sermon is a timely word for life and purpose"
        description="Listen to transformative messages filled with truth, revelation and the power of God."
        image="/sermons.jpeg"
        imageAlt="Sermons"
      />

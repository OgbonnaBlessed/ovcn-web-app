        ...
        <section className="py-24 px-8 lg:px-20 text-center space-y-8">
          <div>
            ...
            <p className="max-w-lg mx-auto mt-2">
              Join services on Sundays by 12:00PM, Wednesdays by 5:30PM, and 3rd
              Fridays by 6:00PM.
            </p>
          </div>
            ...
            <CardContent className="w-full h-full p-0">
              {isLive.youtube ? (
                ...
                <div className="flex items-center justify-center h-full text-muted-foreground">
                  <p>
                    We’re currently offline. Check back during service hours.
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <div className="flex justify-center gap-8 flex-wrap min-w-full">
            {meetings.map((meeting, i) => (
              <div key={i} className="flex flex-col gap-2 items-start">
                <div className="flex justify-start items-center gap-2 bg-accent text-sm px-6 py-4 cursor-pointer min-w-[12rem] rounded-lg ">
